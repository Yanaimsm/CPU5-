...
add wave -noupdate -group MIPSTB_mod -radix decimal /a_mips_tb/U_1/PC
add wave -noupdate -group MIPSTB_mod -radix decimal /a_mips_tb/CLKCNT
add wave -noupdate -group MIPSTB_mod -radix decimal /a_mips_tb/STCNT
add wave -noupdate -group MIPSTB_mod -radix decimal /a_mips_tb/FHCNT
...
add wave -noupdate -group MIPS_mod -color Orchid -radix decimal /a_mips_tb/U_0/PC
add wave -noupdate -group MIPS_mod -color Orchid -radix decimal /a_mips_tb/U_0/CLKCNT_o
add wave -noupdate -group MIPS_mod -color Orchid -radix decimal /a_mips_tb/U_0/FHCNT_o
add wave -noupdate -group MIPS_mod -color Orchid -radix decimal /a_mips_tb/U_0/INSTCNT_o
...
add wave -noupdate -group IF_MOD -radix hexadecimal /a_mips_tb/U_0/IFE/instruction_o
...
add wave -noupdate -group ID_mod /a_mips_tb/U_0/ID/read_data1_o
add wave -noupdate -group ID_mod /a_mips_tb/U_0/ID/read_data2_o
add wave -noupdate -group ID_mod /a_mips_tb/U_0/ID/rt_register_o
add wave -noupdate -group ID_mod /a_mips_tb/U_0/ID/rd_register_o
add wave -noupdate -group ID_mod /a_mips_tb/U_0/ID/write_register_address
add wave -noupdate -group ID_mod /a_mips_tb/U_0/ID/instruction_i
add wave -noupdate -group ID_mod /a_mips_tb/U_0/ID/PC_plus_4_shifted_i
add wave -noupdate -group ID_mod /a_mips_tb/U_0/ID/RegWrite_ctrl_i
add wave -noupdate -group ID_mod /a_mips_tb/U_0/ID/ForwardA_ID
add wave -noupdate -group ID_mod /a_mips_tb/U_0/ID/ForwardB_ID
add wave -noupdate -group ID_mod /a_mips_tb/U_0/ID/BranchBeq_i
add wave -noupdate -group ID_mod /a_mips_tb/U_0/ID/BranchBne_i
add wave -noupdate -group ID_mod /a_mips_tb/U_0/ID/Jump_i
add wave -noupdate -group ID_mod /a_mips_tb/U_0/ID/JAL_i
add wave -noupdate -group ID_mod /a_mips_tb/U_0/ID/Stall_ID
add wave -noupdate -group ID_mod /a_mips_tb/U_0/ID/write_data_i
add wave -noupdate -group ID_mod /a_mips_tb/U_0/ID/Branch_read_data_FW
add wave -noupdate -group ID_mod /a_mips_tb/U_0/ID/sign_extend_o
add wave -noupdate -group ID_mod /a_mips_tb/U_0/ID/PCSrc_o
add wave -noupdate -group ID_mod /a_mips_tb/U_0/ID/JumpAddr_o
add wave -noupdate -group ID_mod /a_mips_tb/U_0/ID/PCBranch_addr_o
add wave -noupdate -group ID_mod /a_mips_tb/U_0/ID/clk_i
add wave -noupdate -group ID_mod /a_mips_tb/U_0/ID/rst_i
add wave -noupdate -group ID_mod -radix hexadecimal -childformat {{/a_mips_tb/U_0/ID/RF_q(0) -radix hexadecimal} {/a_mips_tb/U_0/ID/RF_q(1) -radix hexadecimal} {/a_mips_tb/U_0/ID/RF_q(2) -radix hexadecimal} {/a_mips_tb/U_0/ID/RF_q(3) -radix hexadecimal} {/a_mips_tb/U_0/ID/RF_q(4) -radix hexadecimal} {/a_mips_tb/U_0/ID/RF_q(5) -radix hexadecimal} {/a_mips_tb/U_0/ID/RF_q(6) -radix hexadecimal} {/a_mips_tb/U_0/ID/RF_q(7) -radix hexadecimal} {/a_mips_tb/U_0/ID/RF_q(8) -radix hexadecimal} {/a_mips_tb/U_0/ID/RF_q(9) -radix hexadecimal} {/a_mips_tb/U_0/ID/RF_q(10) -radix hexadecimal} {/a_mips_tb/U_0/ID/RF_q(11) -radix hexadecimal} {/a_mips_tb/U_0/ID/RF_q(12) -radix hexadecimal} {/a_mips_tb/U_0/ID/RF_q(13) -radix hexadecimal} {/a_mips_tb/U_0/ID/RF_q(14) -radix hexadecimal} {/a_mips_tb/U_0/ID/RF_q(15) -radix hexadecimal} {/a_mips_tb/U_0/ID/RF_q(16) -radix hexadecimal} {/a_mips_tb/U_0/ID/RF_q(17) -radix hexadecimal} {/a_mips_tb/U_0/ID/RF_q(18) -radix hexadecimal} {/a_mips_tb/U_0/ID/RF_q(19) -radix hexadecimal} {/a_mips_tb/U_0/ID/RF_q(20) -radix hexadecimal} {/a_mips_tb/U_0/ID/RF_q(21) -radix hexadecimal} {/a_mips_tb/U_0/ID/RF_q(22) -radix hexadecimal} {/a_mips_tb/U_0/ID/RF_q(23) -radix hexadecimal} {/a_mips_tb/U_0/ID/RF_q(24) -radix hexadecimal} {/a_mips_tb/U_0/ID/RF_q(25) -radix hexadecimal} {/a_mips_tb/U_0/ID/RF_q(26) -radix hexadecimal} {/a_mips_tb/U_0/ID/RF_q(27) -radix hexadecimal} {/a_mips_tb/U_0/ID/RF_q(28) -radix hexadecimal} {/a_mips_tb/U_0/ID/RF_q(29) -radix hexadecimal} {/a_mips_tb/U_0/ID/RF_q(30) -radix hexadecimal} {/a_mips_tb/U_0/ID/RF_q(31) -radix hexadecimal}} -subitemconfig {/a_mips_tb/U_0/ID/RF_q(0) {-radix hexadecimal} /a_mips_tb/U_0/ID/RF_q(1) {-radix hexadecimal} /a_mips_tb/U_0/ID/RF_q(2) {-radix hexadecimal} /a_mips_tb/U_0/ID/RF_q(3) {-radix hexadecimal} /a_mips_tb/U_0/ID/RF_q(4) {-radix hexadecimal} /a_mips_tb/U_0/ID/RF_q(5) {-radix hexadecimal} /a_mips_tb/U_0/ID/RF_q(6) {-radix hexadecimal} /a_mips_tb/U_0/ID/RF_q(7) {-radix hexadecimal} /a_mips_tb/U_0/ID/RF_q(8) {-radix hexadecimal} /a_mips_tb/U_0/ID/RF_q(9) {-radix hexadecimal} /a_mips_tb/U_0/ID/RF_q(10) {-radix hexadecimal} /a_mips_tb/U_0/ID/RF_q(11) {-radix hexadecimal} /a_mips_tb/U_0/ID/RF_q(12) {-radix hexadecimal} /a_mips_tb/U_0/ID/RF_q(13) {-radix hexadecimal} /a_mips_tb/U_0/ID/RF_q(14) {-radix hexadecimal} /a_mips_tb/U_0/ID/RF_q(15) {-radix hexadecimal} /a_mips_tb/U_0/ID/RF_q(16) {-radix hexadecimal} /a_mips_tb/U_0/ID/RF_q(17) {-radix hexadecimal} /a_mips_tb/U_0/ID/RF_q(18) {-radix hexadecimal} /a_mips_tb/U_0/ID/RF_q(19) {-radix hexadecimal} /a_mips_tb/U_0/ID/RF_q(20) {-radix hexadecimal} /a_mips_tb/U_0/ID/RF_q(21) {-radix hexadecimal} /a_mips_tb/U_0/ID/RF_q(22) {-radix hexadecimal} /a_mips_tb/U_0/ID/RF_q(23) {-radix hexadecimal} /a_mips_tb/U_0/ID/RF_q(24) {-radix hexadecimal} /a_mips_tb/U_0/ID/RF_q(25) {-radix hexadecimal} /a_mips_tb/U_0/ID/RF_q(26) {-radix hexadecimal} /a_mips_tb/U_0/ID/RF_q(27) {-radix hexadecimal} /a_mips_tb/U_0/ID/RF_q(28) {-radix hexadecimal} /a_mips_tb/U_0/ID/RF_q(29) {-radix hexadecimal} /a_mips_tb/U_0/ID/RF_q(30) {-radix hexadecimal} /a_mips_tb/U_0/ID/RF_q(31) {-radix hexadecimal}} /a_mips_tb/U_0/ID/RF_q
add wave -noupdate -group ID_mod /a_mips_tb/U_0/ID/write_reg_addr_w
add wave -noupdate -group ID_mod /a_mips_tb/U_0/ID/write_reg_data_w
add wave -noupdate -group ID_mod /a_mips_tb/U_0/ID/rs_register_w
add wave -noupdate -group ID_mod /a_mips_tb/U_0/ID/rt_register_w
add wave -noupdate -group ID_mod /a_mips_tb/U_0/ID/rd_register_w
add wave -noupdate -group ID_mod /a_mips_tb/U_0/ID/imm_value_w
add wave -noupdate -group ID_mod /a_mips_tb/U_0/ID/read_data_1_w
add wave -noupdate -group ID_mod /a_mips_tb/U_0/ID/read_data_2_w
add wave -noupdate -group ID_mod /a_mips_tb/U_0/ID/read_data_comp_input_1
add wave -noupdate -group ID_mod /a_mips_tb/U_0/ID/read_data_comp_input_2
add wave -noupdate -group ID_mod /a_mips_tb/U_0/ID/Opcode_w
add wave -noupdate -group ID_mod /a_mips_tb/U_0/ID/sign_extend_w
add wave -noupdate -group ID_mod /a_mips_tb/U_0/PC_plus_4_ID
add wave -noupdate -group ID_mod /a_mips_tb/U_0/IR_ID
add wave -noupdate -group ID_mod /a_mips_tb/U_0/read_data_1_ID
add wave -noupdate -group ID_mod /a_mips_tb/U_0/read_data_2_ID
add wave -noupdate -group ID_mod /a_mips_tb/U_0/Sign_extend_ID
add wave -noupdate -group ID_mod /a_mips_tb/U_0/Wr_reg_addr_0_ID
add wave -noupdate -group ID_mod /a_mips_tb/U_0/Wr_reg_addr_1_ID
add wave -noupdate -group ID_mod /a_mips_tb/U_0/PCBranch_addr_ID
add wave -noupdate -group ID_mod /a_mips_tb/U_0/JumpAddr_ID
add wave -noupdate -group ID_mod /a_mips_tb/U_0/IDpc_0
add wave -noupdate -group ID_mod /a_mips_tb/U_0/IDinstruction_o
add wave -noupdate -group ID_mod /a_mips_tb/U_0/MemtoReg_ID
add wave -noupdate -group ID_mod /a_mips_tb/U_0/RegWrite_ID
add wave -noupdate -group ID_mod /a_mips_tb/U_0/Jal_ID
add wave -noupdate -group ID_mod /a_mips_tb/U_0/MemWrite_ID
add wave -noupdate -group ID_mod /a_mips_tb/U_0/MemRead_ID
add wave -noupdate -group ID_mod /a_mips_tb/U_0/BranchBeq_ID
add wave -noupdate -group ID_mod /a_mips_tb/U_0/BranchBne_ID
add wave -noupdate -group ID_mod /a_mips_tb/U_0/Jump_ID
add wave -noupdate -group ID_mod /a_mips_tb/U_0/ForwardA_ID
add wave -noupdate -group ID_mod /a_mips_tb/U_0/ForwardB_ID
add wave -noupdate -group ID_mod /a_mips_tb/U_0/RegDst_ID
add wave -noupdate -group ID_mod /a_mips_tb/U_0/ALUSrc_ID
add wave -noupdate -group ID_mod /a_mips_tb/U_0/ALUOp_ID
add wave -noupdate -group ID_mod /a_mips_tb/U_0/Stall_ID
add wave -noupdate -group ID_mod /a_mips_tb/U_0/PCSrc_ID
add wave -noupdate -group CONTROL_MOD /a_mips_tb/U_0/CTL/opcode_i
add wave -noupdate -group CONTROL_MOD /a_mips_tb/U_0/CTL/funct_i
add wave -noupdate -group CONTROL_MOD /a_mips_tb/U_0/CTL/RegDst_ctrl_o
add wave -noupdate -group CONTROL_MOD /a_mips_tb/U_0/CTL/ALUSrc_ctrl_o
add wave -noupdate -group CONTROL_MOD /a_mips_tb/U_0/CTL/MemtoReg_ctrl_o
add wave -noupdate -group CONTROL_MOD /a_mips_tb/U_0/CTL/RegWrite_ctrl_o
add wave -noupdate -group CONTROL_MOD /a_mips_tb/U_0/CTL/MemRead_ctrl_o
add wave -noupdate -group CONTROL_MOD /a_mips_tb/U_0/CTL/MemWrite_ctrl_o
add wave -noupdate -group CONTROL_MOD /a_mips_tb/U_0/CTL/BranchBeq_o
add wave -noupdate -group CONTROL_MOD /a_mips_tb/U_0/CTL/BranchBne_o
add wave -noupdate -group CONTROL_MOD /a_mips_tb/U_0/CTL/Jump_o
add wave -noupdate -group CONTROL_MOD /a_mips_tb/U_0/CTL/Jal_o
add wave -noupdate -group CONTROL_MOD /a_mips_tb/U_0/CTL/ALUOp_ctrl_o
add wave -noupdate -group CONTROL_MOD /a_mips_tb/U_0/CTL/clock
add wave -noupdate -group CONTROL_MOD /a_mips_tb/U_0/CTL/reset
add wave -noupdate -group CONTROL_MOD /a_mips_tb/U_0/CTL/rtype_w
add wave -noupdate -group CONTROL_MOD /a_mips_tb/U_0/CTL/itype_imm_w
add wave -noupdate -group CONTROL_MOD /a_mips_tb/U_0/CTL/lw_w
add wave -noupdate -group CONTROL_MOD /a_mips_tb/U_0/CTL/sw_w
add wave -noupdate -group CONTROL_MOD /a_mips_tb/U_0/CTL/beq_w
add wave -noupdate -group CONTROL_MOD /a_mips_tb/U_0/CTL/Bne_w
add wave -noupdate -group CONTROL_MOD /a_mips_tb/U_0/CTL/Addi_w
add wave -noupdate -group CONTROL_MOD /a_mips_tb/U_0/CTL/Ori_w
add wave -noupdate -group CONTROL_MOD /a_mips_tb/U_0/CTL/Xori_w
add wave -noupdate -group CONTROL_MOD /a_mips_tb/U_0/CTL/Andi_w
add wave -noupdate -group CONTROL_MOD /a_mips_tb/U_0/CTL/Shift_w
add wave -noupdate -group CONTROL_MOD /a_mips_tb/U_0/CTL/Lui_w
add wave -noupdate -group CONTROL_MOD /a_mips_tb/U_0/CTL/Slti_w
add wave -noupdate -group CONTROL_MOD /a_mips_tb/U_0/CTL/JalSignal_w
...
WaveRestoreCursors {{Cursor 1} {23686669 ps} 0}
...
update
WaveRestoreZoom {22842491 ps} {24060921 ps}
